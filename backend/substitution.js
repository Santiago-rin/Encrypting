...
function sustitutionEncryptionWithKey(plain_text, key) {
    encrypted_text = '';
...
function sustitutionEncryptionNoKey(plain_text) {
    encrypted_text = '';
    letters_aux = letters;
    key = '';
...
function sustitutionDecryptionWithKey(plain_text, key) {
